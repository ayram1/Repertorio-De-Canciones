    ...
    <div className="min-h-screen bg-black text-white selection:bg-red-500/30 selection:text-white">
      ...
      <header className="sticky top-0 z-30 bg-black/80 backdrop-blur-xl border-b border-red-500/20 px-4 py-4 shadow-[0_4px_20px_rgba(239,68,68,0.05)]">
        <div className="max-w-3xl mx-auto flex flex-col gap-4">
          ...
          <div className="relative" id="search-tour">
      ...
      <main className="max-w-3xl mx-auto px-4 py-6">
        {!tableNumber ? (
          <div className="flex flex-col items-center justify-center p-8 mt-10 bg-neutral-900/50 border border-neutral-800 rounded-2xl text-center">
            <Music2 className="w-12 h-12 text-neutral-600 mb-4" />
            <h2 className="text-xl font-semibold mb-2">Escanea el código QR de tu mesa</h2>
            <p className="text-neutral-400 text-sm">
              Para poder pedir canciones, necesitas escanear el código QR que se encuentra en tu mesa. ¡Así sabremos de dónde viene la petición!
            </p>
          </div>
        ) : loading ? (
